...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.activityTitle.text = NSLocalizedString(@"pray_reading", nil);
    self.activityDescription.text = NSLocalizedString(@"pray_reading_desc", nil);
...
- (void)stopButtonAction
{
    _ispaused = YES;
    self.bottomNav.pauseButton.selected = YES;
    NSString *stopAlert = [NSString stringWithFormat:@"%@ %@%@ %@ %@", NSLocalizedString(@"alert_message1", nil), @"[", NSLocalizedString(@"number_55", nil), NSLocalizedString(@"alert_message3", nil), NSLocalizedString(@"alert_message2", nil)];
    if ([AppDelegate ad].isPortuguese) {
        stopAlert = [NSString stringWithFormat:@"%@ %@ %@ %@ %@", NSLocalizedString(@"alert_message1", nil), NSLocalizedString(@"alert_message3", nil), NSLocalizedString(@"number_55", nil), NSLocalizedString(@"alert_message4", nil), NSLocalizedString(@"alert_message2", nil)];
    }
